...
public class JavaLayerUtils {
	 ...
	 * @param length
	 *            The expected length of the array, or -1 if any length is
	 *            expected.
	 */
	static public Object deserializeArray(InputStream in, Class<?> elemType,
	 ...
	 * 
	 * @param name
	 *            The name of the resource. This must be a simple name, and not
