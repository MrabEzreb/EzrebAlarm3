...
public class jlc {
	...
	static public void main(String args[]) {
		...
		int detail = (ma.verbose_mode ? ma.verbose_level
			...
			while (i < argc) {
				...
				if (argv[i].charAt(0) == '-') {
					if (argv[i].startsWith("-v")) {
						...
						if (argv[i].length() > 2) {
							try {
								...
								System.err
										.println("Invalid verbose level. Using default.");
							}
						}
					 ...
					 */
						...
						if (++i == argc) {
							System.out
									.println("Please specify an output filename after the -p option!");
							System.exit(1);
						}
					 ...
					 * System.out.println(
					 * "Please specify a new scalefactor after the -f option!");
					 * System.exit(1); } ma.use_own_scalefactor = true; //
